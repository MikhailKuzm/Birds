# Предсказание вида птицы по её пению

Приложение определяет 88 видов птиц по аудиозаписи её пения, используя mel-спектограмное представление звука и архитектуру нейронной сети ResNet18.
