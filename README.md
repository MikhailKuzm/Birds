...
благодаря проведённой аугментации.
 ...
 ### Предсказание
 Для предсказания в <b>predict_sound.py</b> была определна функция predict, которая ожидает одну мел-спектограмму. С помощью словаря, предсказанные классы в виде <b>int</b> переводятся в английские наименования
